...
var LOG_PREFIX = 'parse-push-adapter-web';

var ParsePushAdapterWeb = function () {
  function ParsePushAdapterWeb() {
    var pushConfig = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, ParsePushAdapterWeb);

    this.supportsPushTracking = true;

    _npmlog2.default.verbose('Push Adapter intializing...');
  ...
  _createClass(ParsePushAdapterWeb, [{
    ...
    value: function send(data, installations) {
      ...
      _npmlog2.default.verbose(JSON.stringify(installations));
  ...
  return ParsePushAdapterWeb;
}();

exports.default = ParsePushAdapterWeb;